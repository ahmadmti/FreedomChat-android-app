...
public class ImagePickerUtil {
    ...
    public static Intent getPickImageIntent(Context context) {
        ...
        //modified for oreo
        takePhotoIntent.putExtra(MediaStore.EXTRA_OUTPUT, FileProvider.getUriForFile(context, context.getApplicationContext().getPackageName() + ".fileProvider", getTempFile(context)));
        ...
        if (intentList.size() > 0) {
            chooserIntent = Intent.createChooser(intentList.remove(intentList.size() - 1), "Choose one");
...
//                selectedImage = Uri.fromFile(imageFile);
                //modified for oreo
                selectedImage = FileProvider.getUriForFile(context, "com.geeklone.khadamateek_customer.fileProvider", imageFile);
            } else {            /** ALBUM **/
                selectedImage = imageReturnedIntent.getData();
            }

//            final InputStream imageStream = context.getContentResolver().openInputStream(selectedImage);
