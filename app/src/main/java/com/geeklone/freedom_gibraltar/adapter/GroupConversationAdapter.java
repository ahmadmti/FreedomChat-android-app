...
public class GroupConversationAdapter extends RecyclerView.Adapter<GroupConversationAdapter.MyViewHolder> implements Filterable {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new GroupConversationAdapter.MyViewHolder(context,binding, viewModel, sessionManager);
    }
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(Context context, ItemGroupConversationBinding binding, GroupConversationViewModel viewModel, SessionManager sessionManager) {
...
//            item.setConversationDate(conversationDate);
            ...
            binding.ivReceieverUserImg.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    context.startActivity(new Intent(context, FullImageActivity.class)
                            .putExtra("img", item.getMsg())
